...
public class testaMetodo {
	...
	public static void main(String[] args) {
		...
		System.out.println("O saldo da conta do Rodrigo é R$" + contaDoRodrigo.saldo);
		boolean conseguiuRetirar = contaDoRodrigo.saca(20);
		System.out.println("O novo saldo da conta do Rodrigo é R$" + contaDoRodrigo.saldo);
		...
		System.out.println("\n" + "O saldo da conta do Lucas é R$" + contaDoLucas.saldo);
	}
